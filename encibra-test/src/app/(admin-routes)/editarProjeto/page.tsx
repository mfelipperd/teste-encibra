...
import { adicionarProjetos, atualizarProjetos } from '@/api/RESTFULPROJETOS';
...
if (!gestor) {return router.push('/dashboard')}
  return (
    <Container>
      <Stack spacing={3}>
        <Typography variant="h4">Editar Projeto: {data?.nome}</Typography>
        <TextField
          label={data?.nome}
          variant="outlined"
          value={projeto.nome}
